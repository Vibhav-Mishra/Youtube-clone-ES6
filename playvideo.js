...
const videos= async() => {
    ...
    try {
        let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&type=video&key=AIzaSyCTcSf4XMF8NKYmuNlIj2kSI7AwDiTVmRU&maxResults=20&order=viewCount&safeSearch=moderate`);
